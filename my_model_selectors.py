        ...
        for hidden_states_number in range(self.min_n_components, self.max_n_components + 1):
            ...
            try:
                if n_splits > 1:
                    ...
                    for training_set_indices, test_set_indices in split_method.split(self.sequences):
                        ...
                        model = GaussianHMM(n_components=hidden_states_number, covariance_type="diag",n_iter=1000, 
                                            random_state=self.random_state,verbose=False).fit(training_set, test_set_lengths)
